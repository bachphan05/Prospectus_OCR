    ...
    <div className="p-4 border-b border-gray-200">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          {selectedDoc.markdown_file_url && (
            <a
              href={selectedDoc.markdown_file_url}
              download
              target="_blank"
              rel="noopener noreferrer"
              className="px-3 py-1.5 text-sm font-medium text-white bg-teal-600 rounded hover:bg-teal-700 transition-colors flex items-center gap-1"
              title="Download OCR Markdown"
            >
